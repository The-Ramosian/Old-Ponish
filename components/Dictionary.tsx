...
const Dictionary: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-8 py-32 flex flex-col items-center justify-center text-center border-t border-[#e2e8f0]">
      <div className="w-24 h-24 border-4 border-[#4c1d95]/20 border-t-[#4c1d95] rounded-full animate-spin mb-8"></div>
      <h2 className="text-4xl md:text-5xl font-bold text-[#1e293b] mb-6 uppercase tracking-widest">
        Work in Progress
      </h2>
      ...
      <div className="bg-white border-2 border-[#e2e8f0] p-8 rounded-sm shadow-sm max-w-lg w-full">
        <h3 className="text-xl font-bold text-[#1e293b] mb-4 uppercase tracking-wider">Access the Draft</h3>
